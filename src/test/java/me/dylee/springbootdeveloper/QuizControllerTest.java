...
class QuizControllerTest {
    ...
    @DisplayName("quiz() : GET /quiz?code=1 이면 응답 코드 201, 응답 본문은 Created!를 리턴한다.")
    @Test
    ...
    @DisplayName("quiz() : GET /quiz?code=2 이면 응답 코드 400, 응답 본문은 Bad Request!를 리턴한다.")
    @Test
    ...
    @DisplayName("quiz() : POST /quiz에 요청 본문이 {\"value\":1}이면 응답 코드는 403, 응답 본문은 Forbidden를 리턴한다.!")
    @Test
